...
export default class Home extends Component {
        ...
        return (
            <div class="slogan-con">
                ...
                <i class="descr-slogan">
                    The CyPress system is designed to allow you to report
                    problems that concern you about the city. Our mission is to
                    improve the city's public safety through the contibutions of
                    our citizens.
                </i>
                <div class="slogan-btn__con">
    ...
    renderSurvey() {
        return (
            <div>
                <p class="survey-text">
                    We take feedback from our users seriously. This survey will
                    allow us to continously improve our system according to our
                    users needs. This will take approximately 5 minutes to
                    complete.
